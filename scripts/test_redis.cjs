// CommonJS version of test_redis - same logic as the .js file but usable when package.json sets "type":"module".
...
(async () => {
  try {
    ...
    console.error('Unexpected error in test_redis.cjs:', err);
    process.exitCode = 99;
  }
})();
