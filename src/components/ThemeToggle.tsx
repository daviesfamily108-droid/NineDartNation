...
const THEME_META: Record<ThemeName, { icon: string; label: string; gradient: string; ring: string }> = {
  default: {
    icon: '🎯',
    label: 'Default',
...
export default function ThemeToggle() {
  ...
  return (
    <div className="theme-toggle space-y-4" role="group" aria-label="Theme selector">
      {/* Auto toggle */}
