  ...
  return (
    <div
      ...
      style={{
        ...
        paddingBottom: `${cardPaddingBottom ?? 900}px`,
      }}
    >
      <div className="mb-4">
      ...
      {!hiddenSet.has("stats:player-cards") && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {players.map((p, idx) => {
            ...
            const resolvedBestLegDarts = (() => {
              ...
              if (
                typeof all.bestLegDarts === "number" &&
                all.bestLegDarts > 0
              ) {
                    ...
                    <div className="p-2 rounded-lg bg-white/5 border border-white/10">
                      ...
                      <div className="font-semibold">
                        {(() => {
                          ...
                          return a.bestLegDarts
                            ? `${a.bestLegDarts} darts`
                            : "—";
                        })()}
                      </div>
                    </div>
                    ...
                    <div className="p-2 rounded-lg bg-white/5 border border-white/10 col-span-2">
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="font-semibold flex flex-wrap gap-3 text-[13px]">
                            <span>
                              Best 3-dart: {formatAvg(all.best3 || 0)}
                            </span>
                            <span>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="p-2 rounded-lg bg-white/5 border border-white/10 col-span-2">
                      ...
                      <div className="font-semibold flex flex-wrap gap-3 text-[13px]">
                        ...
                        <span>
                          First 9:{" "}
                          {formatAvg(getAllTimeFirstNineAvg(playerName))} ·{" "}
          ...
          {!hiddenSet.has("stats:opponent-compare") && players.length <= 1 && (
      ...
      {!hiddenSet.has("stats:score-distribution") && family !== "other" ? (
        <div className="mt-6 rounded-2xl border border-white/10 bg-black/20 p-4 space-y-4">
          ...
          <div
            className="rounded-xl border border-indigo-500/20 p-3 transform transition-shadow duration-200 hover:shadow-lg overflow-x-auto overflow-y-hidden -mx-1 px-1"
            style={{
              minHeight: statsCardMinHeight ?? 220,
              background: "linear-gradient(135deg, #393053 0%, #635985 100%)",
      ...
      {family === "other" && !hiddenSet.has("stats:other-modes") && (
        <div className="mt-6">
          <div className="mb-3">
